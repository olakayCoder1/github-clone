...
function HeaderTab() {
  return (
    <div className=' sticky top-0 w-full z-50'>
        <div className="sm:flex sm:justify-between sm:pr-4 text-xs md:text-sm font-medium text-center bg-gray-900 sm:bg-[#090909] text-gray-100 border-b-[1px] border-gray-700  mt-6">
